    ...
    <aside className="chat-sidebar">
      <div className="chat-sidebar__header">
        ...
        <div className="chat-sidebar__actions">
          <button
            className="chat-sidebar__compose-btn"
            onClick={onNewConversation}
            title="Nouvelle conversation directe"
          >
            <svg
              width="16"
              height="16"
          ...
          <button
            ...
            onClick={onOpenModal}
            title="Créer ou rejoindre un chat"
          >
            +
          </button>
        </div>
      ...
      <div className="chat-sidebar__list">
        {loading ? (
          ...
          chats.map((chat) => (
            ...
            >
              <span className="chat-sidebar__item-avatar">{chat.nom.charAt(0).toUpperCase()}</span>
